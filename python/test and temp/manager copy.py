...
# -*- coding: utf-8 -*-
# import rospy
# rospy.init_node('faze4_marlin')

# from faze4_host import Faze4
# my_faze4 = Faze4()
# my_faze4.Home()

from go_dispacher import Go_dispacher
my_dispacher = Go_dispacher()
...
import threading
import time
# from go_bridge import mygo_bridge
from RobotEye import myrobotEye
import copy
        ...
        while not self.thread_stop:
            ...
            if GoCommand != "":
                ...
                if GoRunning:
                    ...
                    printGoBoard()
                    print("生成Robot命令：play black " + pos + "\r\n")
                    if goTizi == "":
    ...
    def run(self):
        ...
        while not self.thread_stop:
            ...
            if RobotCommand != "":
                ...
                print("Robot执行完成>>>>\r\n")
                '''
                myarm_bridge.WriteCommand(RobotCommand)
...
if __name__ == '__main__':
    ...
    for le in range(0, 1):
        for num in range(1, 2):
            ...
            my_dispacher.WriteCommand(sendarmCommand)
    # >>>>>>>>>>play game>>>>>>>>>>>>>>>>>>>>>>>
    # if(mygo_bridge.openSocket()):  # and myarm_bridge.openSocket()
    #     NeedOpenCV = True
    #     BeginPlay = True
    #     testRun()
    # else:
    #     print("mygo_bridge 打开失败")
